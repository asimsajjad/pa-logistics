														...
														<select name="expenseName[]" class="expenseNameSelect expenseName-<?=$e?>" style="padding: 3px;margin: 3px;">
															<?php 
																foreach($expenses as $exp) {
																	...
																	if($exp['id'] == $expVal[0]){ echo ' selected '; }
						...
						<div class="col-sm-3">
							<div class="form-group">
								<div class="custom-control custom-checkbox my-1 mr-sm-2">
									<input type="checkbox" class="custom-control-input" id="customControlInline" name="inwrd" value="AK" <?php if($this->input->post('inwrd')=='AK') { echo ' checked'; } ?>>
									<label class="custom-control-label" for="customControlInline">Inward RD</label>
								</div>
								<input name="inwrd_d[]" type="file" class="form-control" multiple>
							</div>
						</div>
						<div class="col-sm-3">
							<div class="form-group">
								<div class="custom-control custom-checkbox my-1 mr-sm-2">
									<input type="checkbox" class="custom-control-input" id="customControlInlineOutwrdDD" name="outwrd" value="AK" <?php if($this->input->post('outwrd')=='AK') { echo ' checked'; } ?>>
									<label class="custom-control-label" for="customControlInlineOutwrdDD">Outward DD</label>
								</div>
								<input name="outwrd_d[]" type="file" class="form-control" multiple>
							</div>
						</div>
						<!-- <div class="col-sm-3">
							<div class="form-group">
...
<script>
	...
	$(document).ready(function() {
		$('input[name="pudate"]').on('change', function() {
			...
			// if (!shipmentType) {
			// 	alert("Please select shipment type first.");
			// 	$('#pudate').val('');
			// 	return; 
			// }
