...
<div class="card mb-3">
            <div class="card-header">
              ...
              Upload Warehouse Dispatch CSV  
              <div class="add_page" style="float: right;">
                   <a class="nav-link" title="Create Section" href="<?php echo  base_url().'admin/paWarehouse';?>"><input type="button" name="add" value="Back" class="btn btn-success btn-sm"/>
                   </a>  
                   </div>
            </div>
            ...
            <div class="col-sm-12">
                ...
                <form class="form form-inline" method="post" action="" enctype="multipart/form-data">
                    ...
                    <p>
                        <a href="<?php echo base_url('admin/paWarehouse/upload-csv/?dummy=csv');?>" style="margin: 0 0 0 10px;" class="btn btn-primary">Dummy CSV</a> 
                        <a href="<?php echo base_url('admin/paWarehouse/upload-csv/?driver-company=csv');?>" style="margin: 0 0 0 10px;" class="btn btn-primary">Driver & Trucking Company List</a>
                    </p>
            </div>
