...
<head>
    <meta charset="UTF-8">
    <title>Inward Receiving Document</title>
    <style>
    @font-face {
    font-family: 'calibri';
                    ...
                    <table>
                        <tr>
                            <td width="64%" style="text-align: left;">
                                <img src="<?php echo base_url()?>assets/images/logo-resized.jpg" style="width:80px;"><br><br>
                                438 N Orinda Ct<br>
                                Tracy CA, 95391<br>
                                (925) 430-5355<br>
                                ...
                                <table width="100%" style="float: right;">
                                    <tr>
                                        <td style="text-align: left;">
                                            <h3 style="display:inline;font-size:15px"><br>Inward RD</h3><br><br>
                                            <strong>Date In:</strong> <?=date($date)?><br><br>
                    ...
                    <tr class="top">
                        <td colspan="2" class="invoicetb">
                            <table border="1" width="100%">
                                <thead>
                                    <tr class="heading">
                                        <td colspan="6">Receiving Summary</td>
                                    </tr>
                                    <tr class="heading">
                                        <td>Sr #.</td>
			...
			<tr class="top">
                <td colspan="2" class="invoicetb">
                    <table border="1"  width="100%" >
                        ...
                        $totalPieces = 0;
                        $thead .= '<thead>
                            <tr class="heading"><td colspan="9">Itemized Details</td></tr>
                            <tr class="heading">';
							   $colspan = 7; 
    							$thead .= '<td>Sr #.</td>
                                <td align="center" style="vertical-align: middle; text-align: center;">Material Number</td>
    							<td>Description</td>
								<td style="vertical-align: middle; text-align: center;">Batch</td>
    							<td style="vertical-align: middle; text-align: center;">Lot Position</td>
    							<td style="vertical-align: middle; text-align: center;">Pallet Number</td>
                                <td style="vertical-align: middle; text-align: center;">Pallet Position</td>
    							<td style="vertical-align: middle; text-align: center;">Pallet Quantity</td>
								<td style="vertical-align: middle; text-align: center;">Pieces Quantity</td>'; 
    						$thead .= '</tr>
                        </thead>';
						echo $thead.'<tbody>';
						if($invoice){
