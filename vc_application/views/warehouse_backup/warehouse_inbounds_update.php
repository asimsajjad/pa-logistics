			...
			<div class="container">		
				...
				<?php
					if(!empty($warehouse)){
						$key = $warehouse[0];
					?>    
					<form method="post" action="<?php echo base_url('admin/warehouse/updateInbounds/').$this->uri->segment(4);?>">
						<?php  echo validation_errors();?>
						<div class="row">
							<div class="col-sm-4 col-md-4 col-xl-2 p-0">
								<div class="form-group">
									<label for="contain">Date IN</label>
									<input class="form-control" type="date" name="dateIn" value="<?php echo date($key['dateIn']); ?>"/>
								</div>
							</div>
