	...
	<div class="container-fluid">
		<div class="col-xs-8 col-sm-12 col-md-12 mobile_content">
			<div class="container">
				...
				<?php } ?>
				<form method="post" enctype="multipart/form-data" action="<?php echo base_url('admin/warehouse/addInbounds');?>">
					...
					<div id="materialContainer">
						<div class="material-group row">
							...
							<div class="col-xl-q col-md-1 col-sm-6 p-0">
								<div class="form-group">
							...
							<div class="col-xl-3 col-md-3 col-sm-6 p-0">
								<div class="form-group">
									...
									<div class="d-flex gap-2">
										...
										<input type="file" name="inboundMaterialFile[0][]" class="form-control inboundMaterialFile" multiple />
...
$(document).ready(function () {
	...
	$(document).on('click', '.duplicateMaterial', function () {
		...
		const notesVal = $currentGroup.find('.notes').val();
		...
		<div class="material-group row">
			...
			<div class="col-xl-12 col-md-12 col-sm-12 p-0" style="margin-top: -20px;">
				<div class="form-group">
					<textarea name="notes[]" class="form-control notes" rows="1" style="height:48px; overflow: hidden;" placeholder="Enter notes">${notesVal}</textarea>
				</div>
			</div>
		</div>`;
