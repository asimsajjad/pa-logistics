...
<div class="card mb-3">
            <div class="card-header">
              ...
              Upload Warehouse Inbounds  
              <div class="add_page" style="float: right;">
                   <a class="" title="Create Section" href="<?php echo  base_url().'admin/warehouseInbounds';?>"><input type="button" name="add" value="Back" class="btn btn-success btn-sm"/>
                   </a>  
                   </div>
            </div>
            ...
            <div class="col-sm-12">
                    ...
                    <ol>
                        <li>Don't change records in <strong> inbound_id, bound_id, Date In, Customer, Warehouse, Sublocation & Material Number </strong> columns.</li>
                        <li>Don't change column order.</li>
                        <li>If you want to add new records than please keep <strong>inbound_id & bound_id</strong> column blank.</li>
                ...
                <form class="form form-inline" method="post" action="" enctype="multipart/form-data">
                    ...
                    <p>
                        <a href="<?php echo base_url('admin/warehouse/uploadInbounds/?dummy=csv');?>" style="margin: 0 0 0 10px;" class="btn btn-primary">Dummy CSV</a> 
                    </p>
            </div>
