						...
						<div class="row">
							<div class="col-sm-4 col-md-4 col-xl-2 p-0">
								<div class="form-group">
									...
									<input readonly class="form-control" type="date" name="dateOut" value="<?php echo date($dated); ?>"/>
								</div>
							</div>
						...
						<div class="material-group row">
							...
							<div class="col-xl-1 col-md-4 col-sm-6 p-0">
								<div class="form-group">
									...
									<input type="number" name="palletQuantity" class="form-control" value="<?php echo $key['pallet_quantity']; ?>"/>
								</div>
							</div>
							<div class="col-xl-2 col-md-4 col-sm-6 p-0">
								<div class="form-group">
									...
									<div class="d-flex gap-2">
										<input type="number" name="piecesQuantity" class="form-control" value="<?php echo $key['pieces_quantity']; ?>" required/>
									</div>
								</div>
							</div>
