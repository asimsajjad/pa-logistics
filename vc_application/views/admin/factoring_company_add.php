<div class="card mb-3">
	<div class="card-header">
		...
		Add Factoring Company <div class="add_page" style="float: right;">
			<a href="<?php echo base_url('admin/factoringCompany');?>" class="nav-link"><input type="button" name="Back" value="Back" class="btn btn-danger btn-sm"/></a>
		</div> 
	</div> 
	<div class="container-fluid">
		<div class="col-xs-8 col-sm-12 col-md-12 mobile_content">
			<div class="container">
				<h3> Add Factoring Company</h3>
				<?php if($this->session->flashdata('item')){ ?>
					<div class="alert alert-success">
						<h4><?php echo $this->session->flashdata('item'); $this->session->set_flashdata('item',''); ?></h4> 
					</div>
				<?php } ?>
				<form method="post" action="<?php echo base_url('admin/factoringCompany/add');?>">
					...
					<div class="row">
						<div class="col-sm-4 col-md-4 col-xs-4">
							<div class="form-group">
								...
								<input name="contactPerson" type="tel" class="form-control">
							</div>
						</div>
						<div class="col-sm-4 col-md-4 col-xs-4">
							<div class="form-group">
					...
					<div class="row">
						...
						<div class="col-sm-3 col-md-3 col-xs-3">
							<div class="form-group">
								...
								<input class="form-control" type="text" name="bankName" value=""/>
							</div>
						</div>
						<div class="col-sm-3 col-md-3 col-xs-3">
							<div class="form-group">
								<label for="contain">Routing #</label>
								<input class="form-control" type="text" name="routingNumber" value=""/>
							</div>
						</div>
						<div class="col-sm-3 col-md-3 col-xs-3">
							<div class="form-group">
