<div class="card mb-3">
 ...
 <a href="<?php echo base_url('admin/insurance');?>" class="nav-link"><input type="button" name="Back" value="Back" class="btn btn-danger btn-sm"/></a>
                     </div> </div>
...
<h4><?php echo $this->session->flashdata('item'); $this->session->set_flashdata('item',''); ?></h4>
          ...
          <?php } ?>
                  ...
                  $key = $insurance[0];
		           ...
		           <form method="post" class="row" action="<?php echo base_url('admin/insurance/update/').$this->uri->segment(4);?>" enctype="multipart/form-data">
					...
					<div class="col-sm-3">   
                        <div class="form-group">
                            ...
                            <input readonly name="startDate" type="text" class="form-control datepicker" value="<?php echo $key['startDate'];?>" required> 
                        </div>
                    </div>  
					...
					<div class="col-sm-3">    
                        <div class="form-group">
                            ...
                            <input readonly name="endDate" type="text" class="form-control datepicker"  value="<?php echo $key['endDate'];?>">
                        </div>
                    </div> 
					...
					<div class="col-sm-4">	
                        <div class="form-group">
                            <label for="contain"> Coverage Amount</label>
                            <input name="coverageAmount" type="number" class="form-control" value="<?php echo $key['coverageAmount'];?>">
                        </div>
                     </div>
					...
					<div class="col-sm-7">	
                        <div class="form-group">
                            <label for="contain"> Insurance Provider</label>
                            <input name="insuranceProvider" type="text" class="form-control" value="<?php echo $key['insuranceProvider'];?>">
                        </div>
                     </div>
					<div class="col-sm-5">	
                        <div class="form-group">
                            <label for="contain"> Policy Number</label>
                            <input name="policyNumber" type="text" class="form-control" value="<?php echo $key['policyNumber'];?>">
                        </div>
                     </div>
					   ...
					   <?php if(!empty($documents)) { 
								foreach($documents as $doc) {
									if($doc['type']=='insurance') { 
										...
										<a href="'.base_url().'admin/insurance/removeSingleDocument/'.$doc['id'].'/'.$key['id'].'" class="remove-file" onclick="return confirm(\'Are you sure delete this file ?\')">X</a>
										<a target="_blank" href="'.base_url('assets/insurance/').''.$doc['fileurl'].'"><i class="far fa-file" style="font-size: 26px;"></i><span>'.$doc['fileurl'].'</span></a></span> &nbsp; '; 
									}
								}
							}
						?>
