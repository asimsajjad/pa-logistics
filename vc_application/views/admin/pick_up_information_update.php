<div class="card mb-3">
	<div class="card-header">
		...
		Update Empty Pick Up Information
		<div class="add_page" style="float: right;">
			<a href="<?php echo base_url('admin/pick-up-Information');?>" class="nav-link"><input type="button" name="Back" value="Back" class="btn btn-danger"/></a>
		</div> 
	</div>
	<div class="container-fluid">
		<div class="col-xs-8 col-sm-8 col-md-8 mobile_content">
			<div class="container">
				...
				<h3> Update Empty Pick Up Information</h3> 
				...
				<?php } 
					...
					if(!empty($PickUpInformation)){
						$key = $PickUpInformation[0];
						
					?>    
					<form method="post" action="<?php echo base_url('admin/pick-up-Information/update/').$this->uri->segment(4);?>">
