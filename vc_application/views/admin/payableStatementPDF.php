                                ...
                                <table class="address-tb" border="0" width="100%">
                                    <tr>
                                        ...
                                        <td class="cls2" width="45%">
											...
											if($company[0]['mc'] != '') { echo 'MC # '.$company[0]['mc'].''; } 
											if($company[0]['dot'] != '') { echo ' | DOT #'.$company[0]['dot'].'<br>'; } 
											?>
                                        </td>
                                    </tr>
                                </table>
			...
			<tr class="top">
                <td colspan="2" class="invoicetb">
                    ...
                    <table border="1"  width="100%" >
						...
						if($invoice){
						    ...
						    foreach($invoice as $dis){
								...
								foreach ($dispatchMeta['dispatchInfo'] as $info) {
									if ($info[0] === "Carrier Ref No") {
										$carrierRefNos[] = $info[1];
									}
									if ($info[0] === "PO No") {
										$customerPONos[] = $info[1];
									}
								}
								...
								// echo $dis['bookedUnderNew'];exit;
								if($dis['bookedUnderNew']==4){
									$amount = $amount + $dis['rate'] + $dis['agentRate'];
								}else{
						...
						if(count($invoice) < 4){
						?>
						<tr><td>&nbsp;</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><?php if($type == 'Drayage') { echo '<td></td>'; } ?></tr>
						<tr><td>&nbsp;</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><?php if($type == 'Drayage') { echo '<td></td>'; } ?></tr>
						<tr><td>&nbsp;</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><?php if($type == 'Drayage') { echo '<td></td>'; } ?></tr>
						<?php } ?>
						<tr><td>&nbsp;</td><td></td><td></td><td></td><td></td><td></td><td></td><td></td><?php if($type == 'Drayage') { echo '<td></td>'; } ?></tr>
						<tr><td colspan="<?=$colspan?>" align="right"><strong>Due Now</strong></td><td align="right">$ <?=number_format($dueNow,2)?></td></tr>
						<?php 
						$totalAmt = $amount;
						if($partialAmt > 0) {
						...
						?>
						<tr><td colspan="<?=$colspan?>" align="right"><strong>Total Revolving</strong></td><td align="right"><strong>$ <?=number_format($totalAmt,2)?></strong></td></tr>
                        </tbody>
                    </table>
                </td>
            </tr>
