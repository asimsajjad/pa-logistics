...
<div class="card mb-3">
	...
	<h3 class="m-0">Carrier Email History</h3>
					...
					<?php
						if(!empty($dispatch)){
							...
							<tr class="tr-<?php echo $key['id'];?>" <?=$bgcolor?>>
								...
								<td style="text-align: center; vertical-align: middle;"><?php echo date('m-d-Y',strtotime($key['date']));?></td>
								<!-- <td style="text-align: center; vertical-align: middle;"><?php echo $key['sender'];?></td>  -->
								<td style="text-align: center; vertical-align: middle;"><?php //echo $key['invoice'];?>
									<a href="<?php echo base_url().'admin/outside-dispatch/update/'.$key['id'];?>"><?php echo $key['invoice'];?></a>
								</td> 
								<td style="text-align: center; vertical-align: middle;"><?php echo $key['customer'];?></td> 
								<td style="text-align: center; vertical-align: middle;"><?php echo $key['carrier'];?></td> 
								<td style="text-align: center; vertical-align: middle;"><?php echo $key['sentToEmail'];?></td> 
								<td style="text-align: center; vertical-align: middle;">
									...
									foreach ($fileNames as $fileName) {
										...
										$fullPath = base_url($filePath . $fileName);
