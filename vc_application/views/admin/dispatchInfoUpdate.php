<div class="card mb-3">
	<div class="card-header">
		...
		<div class="add_page" style="float: right;">
			...
			<a href="<?php echo base_url('admin/dispatch-info');?>" class="nav-link"><input type="button" name="Back" value="Back" class="btn btn-danger"/></a>
		</div> 
	</div>
		...
		<div class="col-xs-8 col-sm-8 col-md-8 mobile_content">
			<div class="container">
				...
				<?php } 
					...
					?>    
					<form method="post" action="<?php echo base_url('admin/dispatch-info/update/').$this->uri->segment(4);?>">
