...
<div class="card mb-3">
	...
	<h3 class="m-0">RTS PA Fleet Invoices</h3>
		...
		<div class="d-flex align-items-center flex-wrap" style="gap: 15px; float: right;">
			<form class="form hide d-none" method="post" id="invoiceSearchForm" action="<?php echo base_url('Invoice/index') ?>">
				<input type="hidden" name="invoiceSearch" id="invoiceSearch" value="pendingInvoices">s				
	...
	<div class="pt-card-body">
		...
		<div class="d-block text-center">
			<form class="form form-inline pt-gap-15" id="rtsSearchForm" method="post" action="">
