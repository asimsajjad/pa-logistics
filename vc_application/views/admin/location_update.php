<div class="card mb-3">
 ...
 <a href="<?php echo base_url('admin/locations');?>" class="nav-link"><input type="button" name="Back" value="Back" class="btn btn-danger"/></a>
                     </div> </div>
...
<h4><?php echo $this->session->flashdata('item'); $this->session->set_flashdata('item',''); ?></h4>
          ...
          <?php } ?>
                  ...
                  $key = $location[0];
                    ...
                    ?>    
		           <form method="post" action="<?php echo base_url('admin/location/update/').$this->uri->segment(4);?>">
						...
						<div class="form-group">
                            ...
                            <input class="form-control" type="text" name="location" value="<?php echo $key['location'] ;?>" required/>
                        </div> 
						...
						<div class="form-group">
                            ...
                            <input class="form-control" type="text" name="notes" value="<?php echo $key['notes'] ;?>"/>
                        </div> 
