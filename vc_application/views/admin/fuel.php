...
<div class="card mb-3">
            <div class="pt-card-header pt-border-bottom d-flex align-items-center justify-content-between bg-transparent">
              ...
              <div class="add_page" style="float: right;">
                   <a class="nav-link" title="Create Section" href="<?php echo  base_url().'admin/fuel/add';?>"><input type="button" name="add" value="Add New" class="btn btn-success pt-cta"/>
                   </a>  </div></div>
            ...
            <div class="d-block text-center">
              ...
              <div class="table-responsive pt-datatbl">
                <table class="table table-bordered display nowrap" id="dataTable1" width="100%" cellspacing="0">
                  ...
                  {
                    ?> 
            <tr><td><a href="<?php echo base_url().'admin/fuel/update/'.$key['id'];?>"><?php echo $key['dname'];?></a></td> 
            <td><?php echo $key['amount'];?></td> 
            <td><?php echo $key['truck'];?></td> 
            <td><?php echo $key['notes'];?></td> 
            <td><?php echo $key['fdate'];?></td> 
            <td><a class="btn btn-sm btn-success" href="<?php echo base_url().'admin/fuel/update/'.$key['id'];?>">Edit <i class="fas fa-edit" title="Edit" alt="Edit"></i></a> 
                      <a style="color:#ff0000;"  href="<?php echo base_url().'admin/fuel/delete/'.$key['id'];?>" onclick="return confirm('Are you sure delete this ?')" ><i class="fas fa-trash-alt" title="Delete" alt="Delete"></a></td></tr> 
