<div class="card mb-3">
            <div class="card-header">
              ...
              Add Truck Supplies Request <div class="add_page" style="float: right;">
        <a href="<?php echo base_url('admin/truck_supplies_request');?>" class="nav-link"><input type="button" name="Back" value="Back" class="btn btn-danger btn-sm"/></a>
                     </div> </div> 
<div class="container-fluid">
		<div class="col-xs-12 col-sm-12 col-md-12 mobile_content">
			    <div class="container">
				    <h3> Add Truck Supplies Request</h3>
...
<h4><?php echo $this->session->flashdata('item'); $this->session->set_flashdata('item',''); ?></h4> 
          ...
          <?php } ?>
					...
					<form method="post" action="<?php echo base_url('admin/truck_supplies_request/add');?>" class="row" enctype="multipart/form-data">
					<div class="col-sm-4">	     
					...
					<div class="col-sm-12">
                        <div class="form-group">
                            <input type="submit" name="save" value="Add Truck Supplies Request" class="btn btn-success"/>
                        </div>
					</div>
					</form>
				</div>
