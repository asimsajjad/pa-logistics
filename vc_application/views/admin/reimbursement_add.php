<div class="card mb-3">
            <div class="card-header">
              ...
              Add Reimbursement <div class="add_page" style="float: right;">
        <a href="<?php echo base_url('admin/reimbursement');?>" class="nav-link"><input type="button" name="Back" value="Back" class="btn btn-danger btn-sm"/></a>
                     </div> </div> 
...
<h4><?php echo $this->session->flashdata('item'); $this->session->set_flashdata('item',''); ?></h4> 
          ...
          <?php } ?>
					...
					<form method="post" action="<?php echo base_url('admin/reimbursement/add');?>" class="row" enctype="multipart/form-data">
					<div class="col-sm-4">	     
					...
					<div class="col-sm-12">
                        <div class="form-group">
                            <input type="submit" name="save" value="Add Reimbursement" class="btn btn-success"/>
                        </div>
					</div>
					</form>
				</div>
