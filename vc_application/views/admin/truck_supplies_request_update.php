<div class="card mb-3">
            <div class="card-header">
              ...
              Update Truck Supplies Request 
             <div class="add_page" style="float: right;">
       
 <a href="<?php echo base_url('admin/truck_supplies_request');?>" class="nav-link"><input type="button" name="Back" value="Back" class="btn btn-danger"/></a>
                     </div> </div>
<div class="container-fluid">
		<div class="col-xs-12 col-sm-12 col-md-12 mobile_content">
			    <div class="container">

				    <h3> Update Truck Supplies Request</h3> 
...
<h4><?php echo $this->session->flashdata('item'); $this->session->set_flashdata('item',''); ?></h4>
          ...
          <?php } ?>
                  ...
                  $key = $truck_supplies_request[0];
		           ...
		           <form method="post" class="row" action="<?php echo base_url('admin/truck_supplies_request/update/').$this->uri->segment(4);?>" enctype="multipart/form-data">
                    ...
                    <div class="col-sm-5">
					   ...
					   <?php if(!empty($documents)) { 
								foreach($documents as $doc) {
									if($doc['type']=='truck_supplies_request') { 
										echo '<span class="doc-file">
										<a href="'.base_url().'admin/truck_supplies_request/removeotherfile/'.$doc['id'].'/'.$key['id'].'" class="remove-file" onclick="return confirm(\'Are you sure delete this file ?\')">X</a>
										<a target="_blank" href="'.base_url('assets/truck_supplies_request/').''.$doc['fileurl'].'"><i class="far fa-file" style="font-size: 26px;"></i><span>'.$doc['fileurl'].'</span></a></span> &nbsp; '; 
									}
								}
							}
						?>
