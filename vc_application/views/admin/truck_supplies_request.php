...
<div class="card mb-3">
            <div class="pt-card-header pt-card-header pt-border-bottom d-flex align-items-center justify-content-between bg-transparent">
              <h3 class="m-0">Truck Supplies Request</h3>
              <div class="add_page" style="float: right;">
                   <a class="nav-link p-0" title="Create Section" href="<?php echo  base_url().'admin/truck_supplies_request/add';?>"><input type="button" name="add" value="Add New" class="btn btn-success pt-cta"/>
                   </a>  </div></div>
            ...
            <div class="mb-3">
              ...
              <div class="table-responsive pt-tbl-responsive">
                <table class="table table-bordereds" id="dataTable1" width="100%" cellspacing="0">
                  ...
                  if(!empty($truck_supplies_request)){
                      $n=1;
                  foreach($truck_supplies_request as $key)
                  {
                    ?> 
            <tr><td><a href="<?php echo base_url().'admin/truck_supplies_request/update/'.$key['id'];?>"><?php echo $key['dname'];?></a></td>  
            <td><?php echo $key['truck'];?></td> 
            <td><?php echo $key['notes'];?></td> 
            <td><?php echo $key['fdate'];?></td> 
            <td><a class="btn btn-sm btn-success pt-cta" href="<?php echo base_url().'admin/truck_supplies_request/update/'.$key['id'];?>">Edit <i class="fas fa-edit" title="Edit" alt="Edit"></i></a> 
                      <a style="color:#ff0000;" class="ml-2"  href="<?php echo base_url().'admin/truck_supplies_request/delete/'.$key['id'];?>" onclick="return confirm('Are you sure delete this ?')" ><i class="fas fa-trash-alt" title="Delete" alt="Delete"></a></td></tr> 
